...
var myCalendar = (function () {
    ...
    var creater = function (calendar) {
        var { parent, viewDay, selectedDay, tdArr } = calendar;
        ...
        (function showControlbar () {
            ...
            updateTextNode(output_year, `${viewDay.year} 년`);
            if (viewDay.month < 10) {
                updateTextNode(output_month, `0${viewDay.month} 월`);
            } else {
                updateTextNode(output_month, `${viewDay.month} 월`);
            }  
        })();      
