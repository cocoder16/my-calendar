var myCalendar = (function () {
    ...
    var run = function (parent, isTodayBtn, size) {
        // 달력생성
        var calendar = {
    ...
    var create = function (parentNode, isTodayBtn) {
        var isTodayBtn = arguments.length > 1 ? arguments[1] : false;
        return run(parentNode, isTodayBtn, 'big');
    }

    var createMini = function (parentNode, isTodayBtn) {
        var isTodayBtn = arguments.length > 1 ? arguments[1] : false;
        return run(parentNode, isTodayBtn, 'mini');
    }
